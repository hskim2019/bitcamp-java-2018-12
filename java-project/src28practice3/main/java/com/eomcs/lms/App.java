...
public class App {
  ...
  private static void loadLessonData() {
    try ( FileReader in = new FileReader("lesson.csv");
       ...
       while(true) {
         //Scanner 클래스의 nextLine()메서드, 번호,제목,내용,시작일,종료일,총강의시간,일강의시간   파일에서 한 줄 읽음
         lessonList.add(Lesson.valueOf(in2.nextLine())); //[11] Lesson에서 만든 valueOf()메서드 호출 : 컴마로 구분 된(번호,제목...,일강의시간)을 배열로 만들어 리턴해주는 메서드
