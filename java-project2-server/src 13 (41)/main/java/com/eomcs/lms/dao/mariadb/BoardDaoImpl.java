...
public BoardDaoImpl(DataSource dataSource) {
	...
	public List<Board> findAll() {   // list
	...
	public List<Board> findByKeyword(String keyword) {   // 검색 기능
	...
	public void insert(Board board) {   //add
		...
		try(PreparedStatement stmt = con.prepareStatement(
				"insert into lms_board(conts) values(?);")) {   //SQL문에 ; 있어도 되고 없어도 됨
	...
	public Board findByNo(int no) {    //detail
