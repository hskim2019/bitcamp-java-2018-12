// 38-2-2
// 9단계: 사진 게시물을 등록할 때 첨부파일 등록과 함께 묶어 처리하라, 즉 한 트랜잭션으로 만들라!
// 트랜잭션
// - 여러 데이터 변경 작업을 한 작업으로 묶은 것
// 작업
// 1) ApplicationInitializer 변경
//    - Connection 객체의 AutoCommit 을 false로 설정한다
