...
public class Test19 {
	public static void main(String[] args) {
		...
		// TypeScript 언어를 할 줄 아는지 검사하기 => 원래값과 조사하려는 값을 &
		//   0000 0000 0001 0111   (원래 값)
		// & 0000 0001 0000 0000   (조사 하려는 값- TypeScript)
		//  ----------------------  조사하려는 값에 0을 AND 하면 무조건 0으로 만든다 / 조사하려는 값에 1을 AND 하면 원래 값 그대로 리턴한다
		//   0000 0000 0000 0000    (결과 값)
		// AND 결과 값을 검사 값과 같은지 비교하면 된다
		//   0000 0000 0000 0000 (결과 값)
		//   0000 0001 0000 0000 (조사한 값)
