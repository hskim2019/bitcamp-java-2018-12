...
// => 주의! 
//    상속이라는 말이 기존 클래스의 코드를 나 몰래 자동으로 복사해오는 것이 아닌가 하는 오해를 많이 한다
//    아니다! 기존 클래스의 코드를 복제해 오지 않는다
//    단지 내 것처럼 사용할 수 있는 권한을 획득하는 것이다
// => 문법
//    class 클래스명 extends 기존클래스명 {...}
// => 용어
//    상속을 해주는 클래스를 "수퍼(super) 클래스", 또는 "부모(parent) 클래스"라 부른다
...
public class Calculator2 extends Calculator {
  ...
  // 그래서 현업에서는 나중에 서브 클래스가 직접 접근할 수 있도록 protected로 접근 범위를 허용한다
