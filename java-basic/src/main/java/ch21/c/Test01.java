// 애플리케이션 에외의 종류: Exception 계열 vs RuntimeException 계열의 예외
package ch21.c;
...
public class Test01 {
  ...
  public static void main(String[] args) {
    ...
    try {
      ...
      // 사용자가 알려준 클래스를 로딩한다. 어떤 class 타입일 지 모르므로 <?>
    ...
    } //catch (NumberFormatException e) {      //해당 부분을 추가해주면 execute() 에서 발생하는 예외를 받아줄 수 있음
      //System.out.println("기타 예외 발생!");   // RuntimeException 계열이라 예외처리 안 해줘도 컴파일 오류는 발생하지 않는다
    //}
  }
  /*
                                         java.lang.Throwable
                                                  │
                                        java.lang.Exception
             java.lang.ReflectiveOperation ┛                    ┗    java.lang.RungtimeException
                           │                                                 │
   InvocationTarger / NoSuchMethod/ ClassNotFound                      java.lang.Illegal ~      
                                                                             │
                                                                    java.lang.NumberFormatExcepton 
