...
public class Test07 {
  ...
  public static void main(String[] args) {
    ...
    //    RuntimeException 계열의 예외도 최소한 main()에서 처리해 줘야 한다
    // RuntimeException 예외는 메서드 선언부에 throws 절을 붙이지 않아도 되기 때문에 코딩하기가 편하다
    // 그래서 대부분의 라이브러리나 프레임워크에서는 개발자가 예외처리를 위해 throws절을 사용하는 번거로움을 덜어주고자 
