...
public class Test04 {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(s2 == s4);  // 인스턴스는 같지 않지만
    System.out.println(s2.equals(s4));   // 안의 내용물은 같음
    System.out.println(s2.hashCode() == s4.hashCode()); // hashCode는 오버라이딩 하지 않아서 다름
    ...
    System.out.println(list);   //toString 오버라이딩 했기 때문에 내용물 전체 출력해줌
