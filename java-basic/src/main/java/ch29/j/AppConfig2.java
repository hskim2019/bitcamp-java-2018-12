...
//     예) ApplicationContext iocContainer = new AnnotationConfigApplicationContext(AppConfig1.class);

// => 그런데 다음과 같이 컨테이너에 Java config 클래스를 직접 알려주지 않을 경우에는
//    이 클래스가 Java config 클래스임을 표시해야만 컨테이너가 알 수 있다
//     예) ApplicationContext iocContainer = new AnnotationConfigApplicationContext("ch29.j");
