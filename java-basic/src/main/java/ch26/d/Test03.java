...
public class Test03 {
	...
	public static void main(String[] args) throws Exception {
		...
		// select 문에서 컬럼을 지정할 때 자바의 인스턴스의 프로퍼티 이름과 다르다면
		...
		// 그래서 mybatis는 컬럼 이름과 같은 이름을 가진 프로퍼티(title, contents)에 대해서만 결과 값을 넣어준다
		// 그래서 Board2 객체를 출력해보면 title과 contents 값만 정상적으로 출력된다
		
		// 해결책
		// =>컬럼 이름과 프로퍼티 명을 같게 하면 됨
		...
		// => 그러면 어떻게 해야 하는것인가?
		//   - select 할 때 컬럼의 별명을 자바의 프로퍼티와 같게 한다
