// SQL을 실행할 때 파라미터 값 넘기기II - 도메인 객체 넘기기
package ch26.e;
...
public class Test02 {
	...
	public static void main(String[] args) throws Exception {
		...
		// insert문을 실행할 때는 insert() 메서드를 호출하라
		// => 그러나 update(), delete()메서드를 호출해도 된다
		// 왜? insert, update, delete모두 JDBC에서 executeUpdate()를 호출하기 때문이다
		...
		board2.put("title", "제목제목제목제목" );
		board2.put("contents", "내용내용내용");
