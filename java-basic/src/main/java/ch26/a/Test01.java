...
//    - mvnrepository.com 에서 mybatis 검색하여 라이브러리 정보 알아낸다
...
public class Test01 {
	...
	public static void main(String[] args) throws Exception {
		...
		//InputStream inputStream2 = new FileInputStream("/home/bitcamp/git/bitcamp-java-2018-12/java-basic/src/main/java/ch26/a/mybatis-config.xml");
