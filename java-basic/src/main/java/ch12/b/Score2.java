...
public class Score2 {
  ...
  // 이렇게 하면 나중에 name에 대해 값의 유효성을 검사하는 코드를 즉시 삽입할 수 있어
  // 유지 보수에도 도움이 된다
  // 그래서 실무에서는 그냥 모든 필드를 private나 protected로 접근을 제한한 다음에
  // setter/getter를 두는 방식으로 프로그래밍을 한다
  // setter/getter가 필요 없는 필드라도 그냥 관성적으로 그렇게 한다
  private String name;
  ...
  public void setName(String name) {
    // 이렇게 유효성 검사하지 않더라도 setter를 그냥 만들라
    this.name = name;
  }
  ...
  // => 착각이다. 필드나 메서드나 공개할 것은 공개하고 공개하지 말아야 하는 것은 공개하지 마라
