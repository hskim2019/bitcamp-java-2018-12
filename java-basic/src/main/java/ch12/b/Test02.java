...
public class Test02 {
  public static void main(String[] args) {
    ...
    // private로 보호되고 있는 메서드는 값을 임의로 왜곡할 수 없다
...
/*
 ...
 - 클래스 멤버(스테틱 멤버) : 스테틱 필드, 스테틱 블록, 스테틱 메서드
 ...
 - 오버로딩(overloading) : 메서드 시그너처가 다르더라도 같은 기능을 하는 메서드에 대해
                         같은 이름을 갖게하여 일관성 있는 프로그래밍을 하게 도와주는 문법
 - 오버라이딩(overriding) : 상속 받은 메서드를 자신의 역할에 맞게 재정의 하는 것
 - 다형적 변수(polymorphic variable) : 하나의 변수가 여러 타입을 가리킬 수 있고, 여러 메서드를 호출할 수 있게 도와주는 문법 
 
 # 캡슐화
 - 클래스 멤버나 인스턴스 멤버의 접근을 제한하는 문법이다
 - 이유? 잘못된 사용으로 왜곡되는 것을 막기 위함
 - 정의된 대로 역할을 수행하게 도와준다
 - 문법 : 클래스 ㅁㅁ버나 인스턴스 멤버 선언할 때 접근 제한자(modifier)를 붙인다
 - 접근 제한자
