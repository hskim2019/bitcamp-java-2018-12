...
public class Test06 {
  ...
  static void printThreads(ThreadGroup tg, String indent) {
    System.out.println("1" + indent + tg.getName() + "(TG)");
...
//JVM의 스레드 계층도
//system(TG)
//         ==> Reference Handler(T)           - reference 관리
//         ==> Finalizer(T)                   - garbage collector 관련
//         ==> Signal Dispatcher(T)           - 외부신호 관련
//   main(TG)                             
//         ==> main(T)                        - main method 호출
...
//                   System(TG)
//  main(TG)                     InnocuousThreadGroup(TG)              ReferenceHandler(T), Finalizer(T), Signal Dispatcher(T)
//    |                                         |
//  main(T)                           common-Cleaner(T)