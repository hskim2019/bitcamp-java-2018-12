...
public class Servlet08 extends GenericServlet {
  ...
  public void init() throws ServletException {
   ...
   // uploadDir = /home/bitcamp/eclipse-workspace2/.metadata/.plugins/org.eclipse.wst.server.core/tmp1/wtpwebapps/java-web/upload
  }
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    // 1) 자바 썸네일 이미지를 생성해주는 자바라이브러리 추가
    //     => mvrepository.com 에서
    //     => build.gradle에 추가
    //     => $ gradle eclipse 실행
    //     => ecalipse IDE에서 프로젝트 리프레시

    //  2) 썸네일 이미지 만들기
    //    => 원본 이미지 파일이 저장된 경로를 알려주고
    //       어떤 썸네일 이미지를 만들어야 되는지 설정한다
