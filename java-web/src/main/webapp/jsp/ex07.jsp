...
page 지시문
1) language="java"
   - JSP 페이지에서 코드를 작성할 떄 사용할 언어를 지정한다
   - 즉 <% 코드 %>, <%= 표현식 %>, <%! 코드 %> 태그에 코드를 작성할 때 사용할 언어이다
   - 원래는 다양한 언어를 사용할 경우를 고려해 설계 되었지만
  ...
  4)import="java.net.Socket"
    ...
    - 사용법
      ...
      => 자바 코드로는
         ...
         import java.util.List;
    - 한 개의 page 지시문에 여러개의 import 를 작성할 수 있다
    - 여러개의 page 지시문을 작성할 수 있다
    
  5) trimDirectiveWhitespaces="true"
    - 지시문 끝에 줄바꿈 코드를 무시하고 싶을 떄 사용한다
